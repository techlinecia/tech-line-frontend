...
function Financeiro() {
  ...
  async function carregarMovimentos() {
    const resposta = await axios.get('https://tech-line-backend.onrender.com/financeiro')
    setMovimentos(resposta.data)
  }

  async function carregarContasFixas() {
    const resposta = await axios.get('https://tech-line-backend.onrender.com/contas-fixas')
  ...
  async function salvarMovimento(event) {
    ...
    if (editando !== null) {
      await axios.put(`https://tech-line-backend.onrender.com/financeiro/${editando}`, dados)
    } else {
      await axios.post('https://tech-line-backend.onrender.com/financeiro', dados)
    }
  ...
  async function salvarContaFixa(event) {
    ...
    if (contaEditando !== null) {
      await axios.put(`https://tech-line-backend.onrender.com/contas-fixas/${contaEditando}`, dados)
    } else {
      await axios.post('https://tech-line-backend.onrender.com/contas-fixas', dados)
    }
  ...
  async function excluirMovimento(id) {
    ...
    await axios.delete(`https://tech-line-backend.onrender.com/financeiro/${id}`)
    carregarMovimentos()
  }
  ...
  async function excluirContaFixa(id) {
    ...
    await axios.delete(`https://tech-line-backend.onrender.com/contas-fixas/${id}`)
    carregarContasFixas()
  }
  ...
  async function marcarContaComoPago(conta) {
    ...
    await axios.put(`https://tech-line-backend.onrender.com/contas-fixas/${conta.id}`, {
      ...conta,
      status: novoStatus
    })
  ...
  async function marcarMovimentoComoPago(item) {
    await axios.put(`https://tech-line-backend.onrender.com/financeiro/${item.id}`, {
      ...item,
      status: 'Pago'
    })
  ...
  async function lancarContaNoFinanceiro(conta) {
    await axios.post('https://tech-line-backend.onrender.com/financeiro', {
      tipo: 'Saída',
