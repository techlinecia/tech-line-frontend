...
function OrdensServico() {
  ...
  async function carregarOrdens() {
    const resposta = await axios.get('https://tech-line-backend.onrender.com/ordens')
  ...
  status: form.status
    ...
    if (ordemEditando !== null) {
      await axios.put(`https://tech-line-backend.onrender.com/ordens/${ordemEditando}`, dadosParaSalvar)
    } else {
      await axios.post('https://tech-line-backend.onrender.com/ordens', dadosParaSalvar)
    }
  ...
  async function excluirOS(id) {
    ...
    await axios.delete(`https://tech-line-backend.onrender.com/ordens/${id}`)
    carregarOrdens()
  }
